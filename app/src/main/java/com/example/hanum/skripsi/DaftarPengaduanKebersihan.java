...
public class DaftarPengaduanKebersihan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_pengaduan_kebersihan);

        recyclerView = findViewById(R.id.daftarPengaduanKebersihan_recyclerView);
        tvKosong = findViewById(R.id.daftarPengaduanKebersihan_labelKosongTv);
        btnFilter = findViewById(R.id.daftarPengaduanKebersihan_filterBtn);
        progressBar = findViewById(R.id.daftarPengaduanKebersihan_progressBar);
        ...
        mRef.child("pengaduan").orderByChild("id").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot data: dataSnapshot.getChildren()){
                    String idBersih = data.child("idBarang").getValue(String.class);
                    if (idBersih.contains("bersih")){
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    for (DataSnapshot data: dataSnapshot.getChildren()){
                                        ...
                                        String idBersih = data.child("idBarang").getValue(String.class);
                                        if (status.equals("belum diterima") && idBersih.contains("bersih")){
                                            pengaduan.setFoto(data.child("foto").getValue(String.class));
                                            pengaduan.setIdBarang(data.child("idBarang").getValue(String.class));
                                            pengaduan.setIdPengadu(data.child("idPengadu").getValue(String.class));
                                            pengaduan.setIdPengaduan(data.getKey());
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    for (DataSnapshot data: dataSnapshot.getChildren()){
                                        String status = data.child("status").getValue(String.class);
                                        String idBersih = data.child("idBarang").getValue(String.class);
                                        if (status.equals("diterima") && idBersih.contains("bersih")){
                                            pengaduan.setFoto(data.child("foto").getValue(String.class));
                                            pengaduan.setIdBarang(data.child("idBarang").getValue(String.class));
                                            pengaduan.setIdPengadu(data.child("idPengadu").getValue(String.class));
                                            pengaduan.setIdPengaduan(data.getKey());
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    for (DataSnapshot data: dataSnapshot.getChildren()){
                                        String status = data.child("status").getValue(String.class);
                                        String idBersih = data.child("idBarang").getValue(String.class);
                                        if (status.equals("sedang diproses") && idBersih.contains("bersih")){
                                            pengaduan.setFoto(data.child("foto").getValue(String.class));
                                            pengaduan.setIdBarang(data.child("idBarang").getValue(String.class));
                                            pengaduan.setIdPengadu(data.child("idPengadu").getValue(String.class));
                                            pengaduan.setIdPengaduan(data.getKey());
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    for (DataSnapshot data: dataSnapshot.getChildren()){
                                        String status = data.child("status").getValue(String.class);
                                        String idBersih = data.child("idBarang").getValue(String.class);
                                        if (status.equals("sedang divendor") && idBersih.contains("bersih")){
                                            pengaduan.setFoto(data.child("foto").getValue(String.class));
                                            pengaduan.setIdBarang(data.child("idBarang").getValue(String.class));
                                            pengaduan.setIdPengadu(data.child("idPengadu").getValue(String.class));
                                            pengaduan.setIdPengaduan(data.getKey());
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    for (DataSnapshot data: dataSnapshot.getChildren()){
                                        String status = data.child("status").getValue(String.class);
                                        String idBersih = data.child("idBarang").getValue(String.class);
                                        if (status.equals("selesai") && idBersih.contains("bersih")){
                                            pengaduan.setFoto(data.child("foto").getValue(String.class));
                                            pengaduan.setIdBarang(data.child("idBarang").getValue(String.class));
                                            pengaduan.setIdPengadu(data.child("idPengadu").getValue(String.class));
                                            pengaduan.setIdPengaduan(data.getKey());
