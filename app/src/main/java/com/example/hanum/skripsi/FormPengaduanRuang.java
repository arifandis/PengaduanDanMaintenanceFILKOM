...
public class FormPengaduanRuang extends AppCompatActivity implements IPickResult {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etDeskripsi = findViewById(R.id.pengaduanRuangan_inputDeskripsiEt);
        btnSubmit = findViewById(R.id.pengaduanRuangan_submitBtn);
