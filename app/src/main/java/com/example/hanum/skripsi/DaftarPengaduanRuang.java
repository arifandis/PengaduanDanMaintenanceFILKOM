...
public class DaftarPengaduanRuang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_pengaduan_ruang);

        recyclerView = findViewById(R.id.daftarPengaduanRuang_recyclerView);
        tvKosong = findViewById(R.id.daftarPengaduanRuang_labelKosongTv);
        btnFilter = findViewById(R.id.daftarPengaduanRuang_filterBtn);
        progressBar = findViewById(R.id.daftarPengaduanRuang_progressBar);
        ...
        mRef.child("pengaduan").orderByChild("id").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot data: dataSnapshot.getChildren()){
                    String idRuang = data.child("idBarang").getValue(String.class);
                    if (idRuang.contains("ruang")){
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    for (DataSnapshot data: dataSnapshot.getChildren()){
                                        ...
                                        String idRuang = data.child("idBarang").getValue(String.class);
                                        if (status.equals("belum diterima") && idRuang.contains("ruang")){
                                            pengaduan.setFoto(data.child("foto").getValue(String.class));
                                            pengaduan.setIdBarang(data.child("idBarang").getValue(String.class));
                                            pengaduan.setIdPengadu(data.child("idPengadu").getValue(String.class));
                                            pengaduan.setIdPengaduan(data.getKey());
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    for (DataSnapshot data: dataSnapshot.getChildren()){
                                        String status = data.child("status").getValue(String.class);
                                        String idRuang = data.child("idBarang").getValue(String.class);
                                        if (status.equals("diterima") && idRuang.contains("ruang")){
                                            pengaduan.setFoto(data.child("foto").getValue(String.class));
                                            pengaduan.setIdBarang(data.child("idBarang").getValue(String.class));
                                            pengaduan.setIdPengadu(data.child("idPengadu").getValue(String.class));
                                            pengaduan.setIdPengaduan(data.getKey());
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    for (DataSnapshot data: dataSnapshot.getChildren()){
                                        String status = data.child("status").getValue(String.class);
                                        String idRuang = data.child("idBarang").getValue(String.class);
                                        if (status.equals("sedang diproses") && idRuang.contains("ruang")){
                                            pengaduan.setFoto(data.child("foto").getValue(String.class));
                                            pengaduan.setIdBarang(data.child("idBarang").getValue(String.class));
                                            pengaduan.setIdPengadu(data.child("idPengadu").getValue(String.class));
                                            pengaduan.setIdPengaduan(data.getKey());
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    for (DataSnapshot data: dataSnapshot.getChildren()){
                                        String status = data.child("status").getValue(String.class);
                                        String idRuang = data.child("idBarang").getValue(String.class);
                                        if (status.equals("sedang divendor") && idRuang.contains("ruang")){
                                            pengaduan.setFoto(data.child("foto").getValue(String.class));
                                            pengaduan.setIdBarang(data.child("idBarang").getValue(String.class));
                                            pengaduan.setIdPengadu(data.child("idPengadu").getValue(String.class));
                                            pengaduan.setIdPengaduan(data.getKey());
                            ...
                            .addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    for (DataSnapshot data: dataSnapshot.getChildren()){
                                        String status = data.child("status").getValue(String.class);
                                        String idRuang = data.child("idBarang").getValue(String.class);
                                        if (status.equals("selesai") && idRuang.contains("ruang")){
                                            pengaduan.setFoto(data.child("foto").getValue(String.class));
                                            pengaduan.setIdBarang(data.child("idBarang").getValue(String.class));
                                            pengaduan.setIdPengadu(data.child("idPengadu").getValue(String.class));
                                            pengaduan.setIdPengaduan(data.getKey());
